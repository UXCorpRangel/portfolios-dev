...
interface CProps {
  width?: number // Tamaño opcional, se puede especificar en px
  height?: number // Tamaño opcional, se puede especificar en px
}

const C: React.FC<CProps> = ({ width = 306, height = 345 }) => {
  return (
    <svg
      viewBox='0 0 306 345'
